...
<body class="index-page">
    <div class="overlay">
        ...
        <header id="header" class="header d-flex align-items-left fixed-top">
            <img src="<?php echo e(asset('images/logo_demak.png')); ?>" class="logo" alt="" style="margin-left: 100px; width: 40px; height: auto;">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="hero-image">
                                <img src="<?php echo e(asset('images/illustration-28.webp')); ?>" class="img-fluid floating" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="about-image">
                                <img src="<?php echo e(asset('images/illustration-14.webp')); ?>" alt="About" class="img-fluid">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="content">
                                ...
                                <div class="stats-row">
                                    <div class="stat-item">
                                        <h3><span data-purecounter-start="0" data-purecounter-end="<?php echo e($jumlahPegawai); ?>" data-purecounter-duration="1" class="purecounter"></span>+</h3>
                                        <p>Jumlah Pegawai</p>
                                    </div>
                                    <div class="stat-item">
                                        <h3><span data-purecounter-start="0" data-purecounter-end="<?php echo e($totalPengajuan); ?>" data-purecounter-duration="1" class="purecounter"></span>+</h3>
                                        <p>Total Pengajuan Cuti</p>
                                    </div>
                                    <div class="stat-item">
                                        <h3><span data-purecounter-start="0" data-purecounter-end="<?php echo e($disetujui); ?>" data-purecounter-duration="1" class="purecounter"></span>+</h3>
...
</html><?php /**PATH D:\Herd\sipecut_1\resources\views/halaman-awal.blade.php ENDPATH**/ ?>